...
// Create several customers and their accounts
        ...
        bank.addCustomer("Tim","Solely");
        customer = bank.getCustomer(4);
        CheckingAccount tim = new CheckingAccount(200.00);
        customer.addAccount(tim);
        tim.withdraw(100); // additional test withdraw
        ...
        if (chkAcct.withdraw(900.00)){
            customer.addAccount(chkAcct);
            System.out.println("withdraw is successfull"+ chkAcct.getBalance());
        }
